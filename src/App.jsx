...
import DetailWithBoundary from "./components/movie/Detail";
      ...
      <Router>
        <div>
          ...
          <Routes>
            ...
            <Route
              path="/movie/:id"
              element={<ProtectedRoute element={<DetailWithBoundary />} />}
            />
            <Route
              path="/movie/:id/trailer"
              element={<ProtectedRoute element={<Trailer />} />}
            />
            <Route
              path="/movie/:id/seatSelection"
              element={<ProtectedRoute element={<SeatSelection />} />}
            />
            <Route
              path="/movie/:id/seatSelection/checkout"
